...
import org.im_bird_sys.SpringUtil;
import org.im_bird_sys.enums.MsgActionEnum;
import org.im_bird_sys.service.UserService;
import org.im_bird_sys.utils.JsonUtils;
...
public class ChatHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, TextWebSocketFrame msg) throws Exception {
        ...
        if(action == MsgActionEnum.CONNECT.type){
            ...
            //需要删除
            System.out.println("接收到的信息："+msgContent);
            ...
            //需要删除
            System.out.println("接收ID："+receiverId);
            System.out.println("发送ID："+senderID);
            //发送信息
            Channel receiverChannel = UserChanelRel.get(receiverId);
            Channel channel1 = UserChanelRel.get(senderID);
            //需要删除
            System.out.println("接收Cannel"+receiverChannel);
            System.out.println("发送Cannel"+channel1);
